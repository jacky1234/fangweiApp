 ...
 */
package com.jacky.sub.beedee.ui.widget.looper;
...
public class LoopViewPager extends ViewPager {
    ...
    private final Runnable runnable = new Runnable() {
        ...
        public void run() {
            ...
            if (autoScroll && currentRunnable != null) {
                postDelayed(currentRunnable, delay);
            }
        }
    };
    ...
    private void updateRunning() {
        if (autoScroll && mVisible == VISIBLE && attached) {
            if (currentRunnable == null) {
                postDelayed(currentRunnable = runnable, delay);
            }
        } else {
            removeCallbacks(currentRunnable);
    ...
    public static class OnPageChangeListenerAdapter implements OnPageChangeListener {
