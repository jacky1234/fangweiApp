package com.jacky.sub.beedee.ui.widget.tag;
...
public class FlowLayout extends RelativeLayout {
    ...
    // 关键字背景
    private int backgroundResource = R.drawable.shape_corner_black;
    // 关键字水平padding，单位为dp
    ...
    public FlowLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        for (int i = 0; i < count; i++) {
            ...
            if (attr == R.styleable.FlowLayoutAttrs_horizontalSpacing) {
                ...
                backgroundResource = typedArray.getResourceId(attr, R.drawable.shape_corner_black);
