package com.jacky.sub.beedee.logic.network;

import android.support.annotation.NonNull;

import com.jacky.sub.beedee.logic.entity.module.Banner;
import com.jacky.sub.beedee.logic.entity.module.Category;
import com.jacky.sub.beedee.logic.entity.module.Good;
import com.jacky.sub.beedee.logic.entity.module.GoodType;
import com.jacky.sub.beedee.logic.entity.module.MySelf;
import com.jacky.sub.beedee.logic.entity.module.User;
import com.jacky.sub.beedee.logic.entity.request.CollectRequest;
import com.jacky.sub.beedee.logic.entity.request.FeedbackRequest;
import com.jacky.sub.beedee.logic.entity.request.LoginRequest;
import com.jacky.sub.beedee.logic.entity.request.QQLoginRequest;
import com.jacky.sub.beedee.logic.entity.request.ReigsterRequest;
import com.jacky.sub.beedee.logic.entity.request.UpdateUserRequest;
import com.jacky.sub.beedee.logic.entity.request.WBLoginRequest;
import com.jacky.sub.beedee.logic.entity.request.WXLoginRequest;
import com.jacky.sub.beedee.logic.entity.response.CollectResponse;
import com.jacky.sub.beedee.logic.entity.response.FavoriteResponse;
import com.jacky.sub.beedee.logic.entity.response.HotVideoResponse;
import com.jacky.sub.beedee.logic.entity.response.HttpResponseSource;
import com.jacky.sub.beedee.logic.entity.response.KeywordResponse;
import com.jacky.sub.beedee.logic.entity.response.ListGoodResponse;
import com.jacky.sub.beedee.logic.entity.response.SecondCategoryResponse;
import com.jacky.sub.beedee.logic.entity.response.UploadFileResponse;
import com.jacky.sub.beedee.logic.network.transformer.BooleanTransformer;
import com.jacky.sub.beedee.logic.network.transformer.HttpListResponseTransformer;
import com.jacky.sub.beedee.logic.network.transformer.HttpResponseTransformer;
