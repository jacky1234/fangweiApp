package com.jacky.sub.beedee.ui.widget.bottombar;
...
public class BottomBarLayout extends LinearLayout {
    ...
    public BottomBarLayout addItem(final BottomBarTab tab) {
        ...
        tab.setOnTouchListener(new OnDoubleClickListener(new OnDoubleClickListener.DoubleClickCallback() {
            @Override
            public void onDoubleClick() {
                if (mDoubleClickListener == null) {
                    return;
                }
                mDoubleClickListener.onTabDoubleClick(tab.getTabPosition());
            }
        }));
    ...
    public void setOnTabDoubleClickListener(OnTabDoubleClickListener onTabDoubleClickListener) {
        mDoubleClickListener = onTabDoubleClickListener;
    }
